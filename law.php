...
if(isset($_POST) && !empty($_FILES['file']['name'])){
	...
	if(move_uploaded_file($_FILES["file"]["tmp_name"][$i],'law/'.$filename)){
	// Image db insert sql
	 $sql = "INSERT into law_order (img_name, image) values('$filename', '$filename')";
        ...
        if($result)
        {
		    ...
		    header("Location: ./law.php"); // used for redirection
...
<body>
    ...
    <div class="container">
        ...
        <form action="law.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
            ...
            <div class='list-group gallery' style="width:100%;">
                ...
                ?>
                    <div class='col-sm-3' style="float: left;">
                        ...
                        <a class="thumbnail fancybox" rel="ligthbox" href="./law/<?php echo $image['image'] ?>">
                        
                            <img alt="" src="./law/<?php echo $image['image'] ?>" />
