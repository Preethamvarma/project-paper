...
if(isset($_POST) && !empty($_FILES['file']['name'])){
	...
	if(move_uploaded_file($_FILES["file"]["tmp_name"][$i],'important Clippings/'.$filename)){
	// Image db insert sql
	 $sql = "INSERT into imp_clippings (img_name, image) values('$filename', '$filename')";
        ...
        if($result)
        {
		    ...
		    header("Location: ./imp_clippings.php"); // used for redirection
...
<body>
    ...
    <div class="container">
        ...
        <form action="imp_clippings.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
                ...
                ?>
                    <div class='col-sm-3' style="float: left;">
                        ...
                        <a class="thumbnail fancybox" rel="ligthbox" href="./uploads/<?php echo $image['image'] ?>">
                            ...
                            <img alt="" src="./important Clippings/<?php echo $image['image'] ?>" />
                        ...
                        <form action="./impdel.php" method="POST">
